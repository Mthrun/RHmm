 ...
 *** 
 *** Class for Viterbi-Algorithm                                                        
 **************************************************************/

#include "StdAfxRHmm.h"

/*
 * Constructor for cViterbi
 * @param theInParam cInParam object containing, the parameters of the HMM
 */
...
/*
 * Dynamic programm to find the viterbi path (most likely sequence of hidden states) in the HMM
 * @param theInParam cInParam object containing, the parameters of the HMM
 * @param theHMM cHMM object, representing the HMM
 */
